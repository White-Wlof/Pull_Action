...
struct  ClientSessionInfo_t707  : public Object_t
{
	...
	ByteU5BU5D_t613* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t613* ___masterSecret_5;
};
struct ClientSessionInfo_t707_StaticFields{
