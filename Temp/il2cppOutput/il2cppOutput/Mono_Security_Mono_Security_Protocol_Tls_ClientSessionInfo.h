...
struct  ClientSessionInfo_t704  : public Object_t
{
	...
	ByteU5BU5D_t610* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t610* ___masterSecret_5;
};
struct ClientSessionInfo_t704_StaticFields{
