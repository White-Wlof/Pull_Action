...
struct  X509Store_t881  : public Object_t
{
	...
	X509Certificate2Collection_t875 * ___list_2;
	...
	X509Store_t680 * ___store_4;
};
struct X509Store_t881_StaticFields{
	...
	Dictionary_2_t185 * ___U3CU3Ef__switchU24mapF_5;
};
